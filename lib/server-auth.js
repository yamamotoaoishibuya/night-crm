...
export function archivedInternalEmail(loginId, userId) {
  const safeUserId = String(userId || "").replace(/-/g, "").slice(0, 12);
  return `${loginId}-hidden-${safeUserId}@night-crm.invalid`;
}
